...
var _EvanRupert$todo_list$Todo$testList = {
	ctor: '::',
	_0: {content: 'Something', id: 0, completed: false},
	_1: {
		ctor: '::',
		_0: {content: 'Something Else', id: 1, completed: false},
		_1: {ctor: '[]'}
	}
};
var _EvanRupert$todo_list$Todo$blankModel = {content: _EvanRupert$todo_list$Todo$testList, cItem: _EvanRupert$todo_list$Todo$blankItem, cId: 0};
var _EvanRupert$todo_list$Todo$Item = F3(
	function (a, b, c) {
		return {content: a, id: b, completed: c};
	});
var _EvanRupert$todo_list$Todo$Model = F3(
	function (a, b, c) {
		return {content: a, cItem: b, cId: c};
	});
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							A2(_elm_lang$core$List$map, _EvanRupert$todo_list$Todo$itemToHtml, model.content)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var Elm = {};
Elm['Todo'] = Elm['Todo'] || {};
if (typeof _EvanRupert$todo_list$Todo$main !== 'undefined') {
    _EvanRupert$todo_list$Todo$main(Elm['Todo'], 'Todo', undefined);
}
